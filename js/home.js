...
module.exports={
  "meme_text": "memes are fun",
  "imgur_client_id": "f0972432933fc36"
}
...
$("#pic").on("change", function (e) {
  ...
  fr.onload = function (e) {
    ...
    img.onload = function () {
      ...
      watermark([canvas.toDataURL()]).image(watermark.text.center(config.meme_text, "120px Impact, Arial", "#fff", 1, null, "#000", 5)).then(function (img) {
        postToImgur(img);
...
},{"../../node_modules/watermarkjs/index":8,"./config.json":1,"./lib/base64ToArrayBuffer":3,"./lib/postToImgur":4,"exif-js":5,"is-mobile":6,"jquery":7}],3:[function(require,module,exports){
"use strict";
...
},{"../config.json":1,"jquery":7}],5:[function(require,module,exports){
(function() {
...
},{"./lib/blob":9,"./lib/canvas":10,"./lib/functions":11,"./lib/image":12,"./lib/style":14}],9:[function(require,module,exports){
...
},{"./image":13,"./text":15}],15:[function(require,module,exports){
/**
 * Return a function for positioning a watermark on a target canvas
 *
 * @param {Function} xFn - a function to determine an x value
